...
% the temporal lag P
TemporalUInputTrain=[BasicU_Series(1:end-5)'; BasicU_Series(2:end-4)';BasicU_Series(3:end-3)';BasicU_Series(4:end-2)';BasicU_Series(5:end-1)'];
TemporalXInputTrain=InputTrain(6:end,:);
TemporalYOutTrain=OutputTrain(6:end);
...
NewTemporalUInputTrain=[NewU_Series(1:end-5)';NewU_Series(2:end-4)';NewU_Series(3:end-3)';NewU_Series(4:end-2)';NewU_Series(5:end-1)'];
