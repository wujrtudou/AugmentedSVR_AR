...
% the temporal lag P
TemporalUInputTrain=[BasicU_Series(1:end-2)'; BasicU_Series(2:end-1)' ];
TemporalXInputTrain=InputTrain(3:end,:);
TemporalYOutTrain=OutputTrain(3:end);
...
NewTemporalUInputTrain=[NewU_Series(1:end-2)';NewU_Series(2:end-1)'];
