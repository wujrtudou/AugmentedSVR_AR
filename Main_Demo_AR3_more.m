...
% the temporal lag P
TemporalUInputTrain=[BasicU_Series(1:end-3)'; BasicU_Series(2:end-2)';BasicU_Series(3:end-1)'];
TemporalXInputTrain=InputTrain(4:end,:);
TemporalYOutTrain=OutputTrain(4:end);
...
NewTemporalUInputTrain=[NewU_Series(1:end-3)';NewU_Series(2:end-2)';NewU_Series(3:end-1)';];
